...
public void simple_Testing_the_Background() {
    System.out.println("This is the second scenarion is Given");
}

@When("^Nothing Clicked$")
public void nothing_Clicked()
{
	System.out.println("This is the second scenarion is When");
}

@Then("^Nothing should happen$")
public void nothing_should_happen()
{
	System.out.println("This is the second scenarion is Then");
}
